---
title: "pathology PA258482 proseg"
format:
    html:
        code-fold: true
        page-layout: full
...
<!-- Auto-converted from `pathology_PA258482_proseg.ipynb`. Source-of-truth for edits is this `.qmd`. -->
...
0, 255, 0     : lime green    : 'Lipidized cells' : #00ff00
51, 134, 90   : Green         : Neuropil zone     : #33865a
255, 255, 0   : Yellow        : Perivascular pseudorosettes : #ffff00
246, 218, 239 : pink          : blood  : #efdaf6
72, 221, 178  : seafoam green : Amorphic material : #48ddb2
124, 123, 38  : brown         : Cerebellum, molecular layer : #7c7b26
70, 138, 112  : grey/green    : Infiltration zone : #468a70
0, 210, 239   : sky blue      : Cerebellum, granule cell layer : #00d2ef
...
ax.set_title(f"Image shape: {V.shape}")
...
pointsI = np.array([[4600.,5000.], [6000., 7000.], [4200., 8000.]])
pointsJ = np.array([[-1000.,-7000.], [-3400., -3500.], [-250., -1200.]])
...
```{python}
print(extentI) #left,right,bottom,top #(xmin, xmax, ymin, ymax) 
V.shape
```
...
'#800000':'Compact. fibrillary component',
'#ff0000':'Microvascular proliferation',
'#000000':'Blood',
...
0,   0,   255 : Dark Blue     : Loose, myxoid component : #0000ff
247, 165, 248 : Light Pink    : Compact. fibrillary component : #f7a5f8
255, 0,   255 : Dark Pink     : Blood : #ff00ff
102, 196, 173 : seafoam green : Dysplastic Neurons / Ganglion Cells : #66c4ad
228, 139, 88  : orange        : Predominantly glial component with dysplastic ganglion cells : #e48b58
41,  144, 2   : Dark Green    : Highly Calcified Area : #299002
