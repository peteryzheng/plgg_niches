---
title: "pathology CN51420 proseg"
format:
    html:
        code-fold: true
        page-layout: full
...
<!-- Auto-converted from `pathology_CN51420_proseg.ipynb`. Source-of-truth for edits is this `.qmd`. -->
...
pointsI = np.array([[500.,500.],[2000.,1000.],
                    [600.,3500.],[2000.,2700.],
                    [3000,1500]])
pointsJ = np.array([[-300.,-5900.],[-3300., -4600.],
                    [-400., -550.],[-3300., -2100.],
                    [-5000,-3900]])
